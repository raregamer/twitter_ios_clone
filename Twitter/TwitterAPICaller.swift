...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    ...
    func postFavoriteTweet(tweetId: Int, success: @escaping () -> (), failure: @escaping (Error) -> ()){
    ...
    func postUnFavoriteTweet(tweetId: Int, success: @escaping () -> (), failure: @escaping (Error) -> ()){
